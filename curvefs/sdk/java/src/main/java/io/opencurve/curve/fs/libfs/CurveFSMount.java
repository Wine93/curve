...
public class CurveFSMount {
    ...
    private static native int nativeCurveFSListDirPlus(long instancePtr, CurveFsDirent[] dirents, long size);
    // file*
    ...
    public int listdirplus(String path, CurveFsDirent[] dirents, long size) throws IOException {
        logger.log("listdir", path);
        return 0;
        //return nativeCurveFSListDir(instancePtr, path);
    }
